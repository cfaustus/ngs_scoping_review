...
hist_sample_size_compartment_aim <-
  ggsave(filename = "figures/histogram_sample_size_by_compartment_colored_by_study_aim.pdf", width=8, height = 8)
...
hist_sample_size_compartment_agent_type
hist_sample_size_compartment_agent_type |>
  ggsave(filename = "figures/histogram_sample_size_by_compartment_colored_by_agent_type.pdf", width=8, height = 8)
